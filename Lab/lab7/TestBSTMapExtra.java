...
public class TestBSTMapExtra {
    ...
    *  when the node has only 1 or 0 children on either side. */
    ...
    public void testRemoveRootEdge() {
        ...
        assertTrue(( rightChild.remove('D')).equals(Integer.valueOf(4)));
        assertTrue(( rightChild.remove('G')).equals(Integer.valueOf(7)));
        assertTrue(( rightChild.remove('A')).equals(Integer.valueOf(100)));
